...
document.getElementById('getExample').textContent = `GET ${baseUrl}/api/qr/generate?text=HelloWorld&size=200&format=png`;
        ...
        if (response.ok) {
            ...
            resultDiv.innerHTML = `
                <h3 class="text-2xl font-bold text-white mb-4">Your QR Code:</h3>
                    ...
                    <p class="mt-4">
                        <a href="${url}" 
                            download="qr-code.${formData.format}"
